...
';      $fp = fopen('/var/www/html/sdr.conf', 'w');
    ...
    fclose($fp);
    sleep(1);
shell_exec('nohup rtl_fm -M fm -f '.$configs['APRSSDR_FREQ'].'M -s 48000 -d '.$configs['APRSSDR_SDR_DONGLE'].' - | direwolf -c /var/www/html/sdr.conf -r 48000 -D 1 -B '.$configs['APRSSDR_BAUD'].' - > /var/www/html/dwsdr.log.txt &'); // 
...
FILTER 0 0 ! b/PU5MMR-*/PY5NCC-*/PY5DGS-*/PY5DGL-*/PU5OBL-*/PU5RFP-*/PP5PH-* ';
}
if ($configs['APRSSOUNDCARD_IGTX']) {
	if (empty($configs['APRSSOUNDCARD_APRSISFILTER'])) $configs['APRSSOUNDCARD_APRSISFILTER'] = 'm/50';
  $DWConf.='
FILTER 0 IG ! b/PU5MMR-*/PY5NCC-*/PY5DGS-*/PY5DGL-*/PU5OBL-*/PU5RFP-*/PP5PH-* 
IGFILTER '.$configs['APRSSOUNDCARD_APRSISFILTER'].'
FILTER IG 0 ! b/PU5MMR-*/PY5NCC-*/PY5DGS-*/PY5DGL-*/PU5OBL-*/PU5RFP-*/PP5PH-* 
';
}
